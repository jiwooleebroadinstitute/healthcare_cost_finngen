...
# ENDPOINT DATA
cp /finngen/library-red/finngen_R11/phenotype_1.0/data/finngen_R11_endpoint_1.0.txt.gz .
gunzip finngen_R11_endpoint_1.0.txt.gz

head -1 finngen_R11_endpoint_1.0.txt | tr '\t' '\n' | cat -n | grep "FINNGENID"
head -1 finngen_R11_endpoint_1.0.txt | tr '\t' '\n' | cat -n | grep "BL_AGE"
head -1 finngen_R11_endpoint_1.0.txt | tr '\t' '\n' | cat -n | grep "BL_YEAR"
...
awk '{print $1, $2, $3, $4, $5, $6, $7, $8}' finngen_R11_endpoint_1.0.txt > finngen_R11_endpoint_1.0_clean.txt
...
start_year = 2000
start_year_hilmo_kela = 2000
start_year_avohilmo = 2011
end_year = 2020

# LOAD ENDPOINT DATA
endpoint_all = fread(file = paste0(path, "finngen_R11_endpoint_1.0_clean.txt"), header = TRUE, stringsAsFactors = FALSE)
...
endpoint_all = endpoint_all[,c("finngenid", "sex", "birth_year", "death_year", "death_age", "death", "bl_age", "bl_year", "fu_end_age", "fu_end_year", "person_day_in_hilmo_kela", "person_day_in_avohilmo")]
endpoint_new = endpoint_all[which(endpoint_all$person_day_in_hilmo_kela > 0),]
dim(endpoint_all) # 473681
dim(endpoint_new) # 466973

# LOAD PCA DATA
pca_all = fread(file = "/finngen/library-red/finngen_R10/pca_1.0/data/finngen_R10_eigenvec.txt", header = TRUE, stringsAsFactors = FALSE)
pca_new = pca_all[,-"#FID"]
...
long_all = fread(file = "/finngen/library-red/finngen_R11/service_sector_data_1.0/data/finngen_R11_service_sector_detailed_longitudinal_1.0.txt.gz", header = TRUE, stringsAsFactors = FALSE)
...
fwrite(total_new, paste0(path, "healthcare_cost_20230303.txt"), row.names = FALSE, col.names = TRUE)
...
# FINALIZE DATAFRAME
total_new = fread(file = paste0(path, "healthcare_cost_20230303.txt"), header = TRUE, stringsAsFactors = FALSE)
...
# MAKE GWAS DATAFRAME
cov_all = fread(file = "/finngen/library-red/finngen_R11/analysis_covariates/R11_COV_PHENO_V0.FID.txt.gz", header = TRUE, stringsAsFactors = FALSE)
...
cov_new = cov_all[,1:186]
cov_new = merge(cov_new, temp, by.x = "FID", by.y = "finngenid")
...
cov_new$log_total_cost_per_person_year_5_18 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 5 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 18, cov_new$log_total_cost_per_person_year, NA)
cov_new$log_total_cost_per_person_year_19_35 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 19 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 35, cov_new$log_total_cost_per_person_year, NA)
cov_new$log_total_cost_per_person_year_36_55 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 36 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 55, cov_new$log_total_cost_per_person_year, NA)
cov_new$log_total_cost_per_person_year_56_75 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 56 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 75, cov_new$log_total_cost_per_person_year, NA)
cov_new$log_total_cost_per_person_year_76_95 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 76, cov_new$log_total_cost_per_person_year, NA)

cov_new$log_kela_cost_per_female_year = ifelse(cov_new$SEX == "female", cov_new$log_kela_cost_per_person_year, NA)
cov_new$log_kela_cost_per_male_year = ifelse(cov_new$SEX == "male", cov_new$log_kela_cost_per_person_year, NA)
cov_new$log_kela_cost_per_person_year_5_18 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 5 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 18, cov_new$log_kela_cost_per_person_year, NA)
cov_new$log_kela_cost_per_person_year_19_35 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 19 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 35, cov_new$log_kela_cost_per_person_year, NA)
cov_new$log_kela_cost_per_person_year_36_55 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 36 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 55, cov_new$log_kela_cost_per_person_year, NA)
cov_new$log_kela_cost_per_person_year_56_75 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 56 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 75, cov_new$log_kela_cost_per_person_year, NA)
cov_new$log_kela_cost_per_person_year_76_95 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 76, cov_new$log_kela_cost_per_person_year, NA)

cov_new$log_hilmo_cost_per_female_year = ifelse(cov_new$SEX == "female", cov_new$log_hilmo_cost_per_person_year, NA)
cov_new$log_hilmo_cost_per_male_year = ifelse(cov_new$SEX == "male", cov_new$log_hilmo_cost_per_person_year, NA)
cov_new$log_hilmo_cost_per_person_year_5_18 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 5 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 18, cov_new$log_hilmo_cost_per_person_year, NA)
cov_new$log_hilmo_cost_per_person_year_19_35 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 19 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 35, cov_new$log_hilmo_cost_per_person_year, NA)
cov_new$log_hilmo_cost_per_person_year_36_55 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 36 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 55, cov_new$log_hilmo_cost_per_person_year, NA)
cov_new$log_hilmo_cost_per_person_year_56_75 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 56 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 75, cov_new$log_hilmo_cost_per_person_year, NA)
cov_new$log_hilmo_cost_per_person_year_76_95 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 76, cov_new$log_hilmo_cost_per_person_year, NA)

cov_new$log_avohilmo_cost_per_female_year = ifelse(cov_new$SEX == "female", cov_new$log_avohilmo_cost_per_person_year, NA)
cov_new$log_avohilmo_cost_per_male_year = ifelse(cov_new$SEX == "male", cov_new$log_avohilmo_cost_per_person_year, NA)
cov_new$log_avohilmo_cost_per_person_year_5_18 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 5 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 18, cov_new$log_avohilmo_cost_per_person_year, NA)
cov_new$log_avohilmo_cost_per_person_year_19_35 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 19 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 35, cov_new$log_avohilmo_cost_per_person_year, NA)
cov_new$log_avohilmo_cost_per_person_year_36_55 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 36 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 55, cov_new$log_avohilmo_cost_per_person_year, NA)
cov_new$log_avohilmo_cost_per_person_year_56_75 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 56 & cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP < 75, cov_new$log_avohilmo_cost_per_person_year, NA)
cov_new$log_avohilmo_cost_per_person_year_76_95 = ifelse(cov_new$AGE_AT_DEATH_OR_END_OF_FOLLOWUP >= 76, cov_new$log_avohilmo_cost_per_person_year, NA)

cov_new = cov_new %>% mutate_all(na_if," ")
fwrite(list(paste0(colnames(cov_new), collapse = ",")), paste0("~/jiwoo/gencost_regenie/covariates.txt"))
...
phenolist = fread("~/jiwoo/gencost_regenie/phenolist.txt", header = FALSE)
colnames(phenolist) = c("phenotype")
for (i in 1:length(phenolist$phenotype)) {
	print(phenolist$phenotype[i])
	write(phenolist$phenotype[i], paste0("~/jiwoo/gencost_regenie/phenolist/", phenolist$phenotype[i], ".txt"))
	if (grepl("male", phenolist$phenotype[i])) {
		cov_temp = cov_new[,c(1:3,7:141,167:187)]
		cov_temp[[phenolist$phenotype[i]]] = cov_new[[phenolist$phenotype[i]]]
	} else {
		cov_temp = cov_new[,c(1:3,7:141,165:166,167:187)]
		cov_temp[[phenolist$phenotype[i]]] = cov_new[[phenolist$phenotype[i]]]
	}
	cov_temp = cov_temp[which(!is.na(cov_temp[[phenolist$phenotype[i]]]))]
	fwrite(cov_temp, paste0("~/jiwoo/gencost_regenie/pheno/", phenolist$phenotype[i], ".txt"), sep = "\t", col.names = TRUE, row.names = FALSE, quote = FALSE)
	temp = fread(file = paste0("~/jiwoo/gencost_regenie/pheno/", phenolist$phenotype[i], ".txt"), header = TRUE, stringsAsFactors = FALSE)
	fwrite(temp, paste0("~/jiwoo/gencost_regenie/pheno/", phenolist$phenotype[i], ".txt"), sep = "\t", col.names = TRUE, row.names = FALSE)
}
...
#finngen-cli rw -w ./regenie.wdl -i ./json/log_total_cost_per_person_year.json -d ./regenie_sub_r8mem.zip

#finngen-cli rw -w ./regenie.wdl -i ./json/log_avohilmo_cost_per_female_year.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_hilmo_cost_per_female_year.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_kela_cost_per_female_year.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_total_cost_per_female_year.json -d ./regenie_sub_r8mem.zip

#finngen-cli rw -w ./regenie.wdl -i ./json/log_avohilmo_cost_per_male_year.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_hilmo_cost_per_male_year.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_kela_cost_per_male_year.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_total_cost_per_male_year.json -d ./regenie_sub_r8mem.zip

#finngen-cli rw -w ./regenie.wdl -i ./json/log_avohilmo_cost_per_person_year_5_18.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_hilmo_cost_per_person_year_5_18.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_kela_cost_per_person_year_5_18.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_total_cost_per_person_year_5_18.json -d ./regenie_sub_r8mem.zip

#finngen-cli rw -w ./regenie.wdl -i ./json/log_avohilmo_cost_per_person_year_19_35.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_hilmo_cost_per_person_year_19_35.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_kela_cost_per_person_year_19_35.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_total_cost_per_person_year_19_35.json -d ./regenie_sub_r8mem.zip

#finngen-cli rw -w ./regenie.wdl -i ./json/log_avohilmo_cost_per_person_year_36_55.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_hilmo_cost_per_person_year_36_55.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_kela_cost_per_person_year_36_55.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_total_cost_per_person_year_36_55.json -d ./regenie_sub_r8mem.zip

#finngen-cli rw -w ./regenie.wdl -i ./json/log_avohilmo_cost_per_person_year_56_75.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_hilmo_cost_per_person_year_56_75.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_kela_cost_per_person_year_56_75.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_total_cost_per_person_year_56_75.json -d ./regenie_sub_r8mem.zip

#finngen-cli rw -w ./regenie.wdl -i ./json/log_avohilmo_cost_per_person_year_76_95.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_hilmo_cost_per_person_year_76_95.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_kela_cost_per_person_year_76_95.json -d ./regenie_sub_r8mem.zip
#finngen-cli rw -w ./regenie.wdl -i ./json/log_total_cost_per_person_year_76_95.json -d ./regenie_sub_r8mem.zip
...
g = grid.arrange(a, b, c, d, left = textGrob("Number of Individuals", rot = 90, gp = gpar(fontsize = 25)), bottom = textGrob("Annual Healthcare Cost in Euros", gp = gpar(fontsize = 25)))
ggsave(paste0(path, "distribution.jpg"), g, device = "jpg", type = "cairo", height = 10, width = 20)
...
path = "C:/Jiwoo_Lee/Research/Healthcare_Cost_2021/"
today = "20220505"
...
ggsave(paste0(path, "MR/", today, "/sensitivity_new.jpg"), G, device = "jpg", type = "cairo", height = 10, width = 30)
